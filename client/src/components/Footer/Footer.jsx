...
const Footer = () => {
    return (
      <footer className="bg-gray-100 shadow-md w-full p-6 relative bottom-0 left-0 right-0">
        <div className="container mx-auto flex flex-wrap justify-between items-start gap-8 md:flex-nowrap">
          
          <div className="w-full md:w-1/4">
            <h3 className="text-lg font-semibold text-gray-800">About</h3>
            <p className="text-sm text-gray-600 mt-2">
              Your go-to marketplace for buying and selling products. Find great deals and connect with buyers easily.
            </p>
          </div>
          ...
          <div className="w-full md:w-1/4">
            ...
            <ul className="text-sm text-gray-600 mt-2 space-y-2">
              ...
              <li><a href="#" className="hover:text-blue-500">Safety Tips</a></li>
          ...
          <div className="w-full md:w-1/4">
            ...
            <ul className="text-sm text-gray-600 mt-2 space-y-2">
              <li><a href="#" className="hover:text-blue-500">Post Ads</a></li>
              <li><a href="#" className="hover:text-blue-500">Secure Payments</a></li>
              <li><a href="#" className="hover:text-blue-500">Verified Sellers</a></li>
            </ul>
          </div>
